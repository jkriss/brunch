...
let isWindows = exports.isWindows = helpers.isWindows;
  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      const items = Object.keys(json.dependencies || {}).filter(dep => {
        ...
        if (depJson.main && sysPath.extname(depJson.main) == '') depJson.main += '.js'
...
var tryToLoad = function(configPath) {
  let fullPath;
  return new Promise((resolve, reject) => {
    try {
